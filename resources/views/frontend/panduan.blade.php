        ...
        <div class="tentang" style="margin-top: -20px">
            <div class="container">
                ...
                <ol class="text-justify mt-3 penelitian" style="margin-left: -24px;font-size: 16px">
                    <li><a href="{{ asset('panduan/pedoman.pdf') }}" class="ml-5" target="_blank">Pedoman Penulisan Skripsi</a></li>
                    <li><a href="{{ asset('panduan/KARTU BIMBINGAN SKRIPSI.pdf') }}" class="ml-5" target="_blank">Kartu Bimbingan Skripsi</a></li>
                    <li><a href="" class="ml-5">Panduan Upload Skripsi</a></li>
                    <li><a href="{{ asset('img/logo.png') }}" class="ml-5" target="_blank">Logo STIE Cendekia Karya Utama ( NO.48/SK/CKU/2021)</a></li>
